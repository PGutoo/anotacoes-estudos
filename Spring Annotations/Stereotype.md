As anotações Stereotypes são usadas para indicar ao Spring quais e como as classes serão gerenciadas, são usadas para indicar quais os beans do projeto.
